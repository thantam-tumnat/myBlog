...
func LoadConfigs(cfg *Configs) {
	...
	cfg.App.Port = os.Getenv("BLOG_PORT")

	cfg.PostgreSQL.Host = os.Getenv("DB_HOST")
	cfg.PostgreSQL.Port = os.Getenv("DB_PORT")
	cfg.PostgreSQL.Username = os.Getenv("DB_USERNAME_BLOG")
	cfg.PostgreSQL.Password = os.Getenv("DB_PASSWORD_BLOG")
	cfg.PostgreSQL.Database = os.Getenv("DB_DATABASE_BLOG")
	cfg.PostgreSQL.Schema = os.Getenv("DB_SCHEMA_BLOG")
